...
由於本系統皆由免費資源所建置完成，故主要受到以下資源條件所影響:  
  
Gemini 2.5 Pro : 每分鐘250,000 tokens限制，每日6,000,000 tokens限制  
  
LINE Messaging API : 每月免費訊息500則  
  
Render Web Service : 每月運行時數750小時，但閒置時會進入休眠，雖不計時數，但須由外部訊息喚醒instance
